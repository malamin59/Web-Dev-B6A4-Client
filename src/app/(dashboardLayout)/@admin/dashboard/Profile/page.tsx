        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-sm text-zinc-400 mt-0.5">
              Manage your personal details, connected providers, and security
              preferences.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => signOut()}
              className="p-2 flex justify-center gap-1 items-center bg-red-950/40 hover:bg-red-900/60 text-red-400 border border-red-800/40 rounded-xl transition"
              title="Sign Out"
            >
              Logout
          ...
          <div className="px-6 sm:px-8 pb-8 relative">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 bg-zinc-950/60 rounded-2xl border border-zinc-800/80">
              ...
              <div className="space-y-1">
                ...
                <p className="text-base font-bold text-white">
                  {user?.connectedAppsCount !== undefined
                    ? `${user.connectedAppsCount} Active`
                    : "1 Active"}
                </p>
              </div>
